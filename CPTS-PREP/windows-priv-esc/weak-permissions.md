```markdown
# 🛰️ Weak Permissions Privilege Escalation
...
> [!SUCCESS] Privilege Escalation Steps
```cmd
...
### Lab Environment
> [!INFO] Credentials and Access Method
