```markdown
# 🛰️ Print Operators Privilege Escalation
...
[!INFO]SeLoadDriverPrivilege         # Load and unload device drivers
[!NOTE]SeShutdownPrivilege           # Shut down Domain Controller
...
# Expected output:
[!CHECK]SeLoadDriverPrivilege         Load and unload device drivers       Disabled
```
...
[!SUCCESS]EnableSeLoadDriverPrivilege.exe
