...
> [!ABSTRACT] Content Validation: Bypassing Content-Type headers and MIME-Type validation using magic bytes
...
> [!INFO] Header Manipulation: Modifying the Content-Type header to bypass validation
...
> [!INFO] Magic Bytes: Using file signatures to fool MIME-Type detection
...
> [!NOTE] Target: Bypass Client-Side, Blacklist, Whitelist, Content-Type, and MIME-Type filters
