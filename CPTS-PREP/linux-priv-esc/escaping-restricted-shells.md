...
> [!ABSTRACT] Overview of Techniques
> This document covers methods to escape restricted shells (rbash, rksh, rzsh) which limit command execution and environment modification.
...
### HTB Academy Example
> [!SUCCESS] Example of successful escape
```bash
...
> [!SUCCESS] Comprehensive sequence for escaping restricted shell
```bash
...
### Emergency Escapes
> [!INFO] Quick commands to check shell type and available resources
```bash
