...
> [!ABSTRACT] Overview of LXD Exploitation
> LXD (Linux Daemon) container manager can be exploited for privilege escalation when a user is a member of the `lxd` group through privileged container creation and host filesystem mounting.
