# 🛰️ FTP Enumeration Techniques

## Introduction to FTP Enumeration

FTP (File Transfer Protocol) is a standard network protocol used for transferring files between computers over any TCP/IP-based network. The following guide outlines various techniques and methodologies for enumerating FTP services, including command-line tools, automated scripts, and manual probing methods.

[!INFO] This document provides an in-depth look at the process of discovering information about FTP servers through a combination of reconnaissance, authentication testing, directory traversal, and configuration analysis.
...
```bash
# Standard TCP scan for port 21
nmap -p 21 target_ip

# Enhanced version detection
nmap -sV --script=ftp-anon,target_ip

# Example output:
PORT   STATE SERVICE VERSION
21/tcp open  ftp     vsftpd 3.0.3
| ftp-syst: 
|_SYST: UNIX emulated by vsFTPd 3.0.3
```
