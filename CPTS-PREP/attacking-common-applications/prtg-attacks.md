...
> [!ABSTRACT] 🎯 Objective: Exploit PRTG Network Monitor's command injection vulnerability (CVE-2018-9276) for authenticated remote code execution through notification system abuse.

## Overview

PRTG Network Monitor is an agentless network monitoring software running on Windows. Common ports:
```text
80/tcp, 443/tcp, 8080/tcp
```
Vulnerable versions **< 18.2.39** suffer from authenticated command injection in notification parameters.

---

## HTB Academy Lab Solutions

### 🕵️‍♂️ Lab 1: Version Discovery
> [!QUESTION]
...
### 🛠️ Lab 2: RCE via Command Injection
> [!QUESTION]
