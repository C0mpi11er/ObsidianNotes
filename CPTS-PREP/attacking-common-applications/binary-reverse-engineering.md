...
> [!ABSTRACT] Objective:
> Extract database connection strings and credentials from compiled applications using reverse engineering techniques.
...
> [!INFO] SSH Access:
> `htb-student:HTB_@cademy_stdnt!` → `10.129.205.20`
...
|-----------------|---------|
| SQL Server      | sa, admin accounts |
| Database Name   | db_name |
| Network Topology | server:port |
