...
> [!INFO] Purpose: Hide your real IP among fake ones
...
> [!INFO] Purpose: Split packets to evade signature-based detection
...
> [!INFO] Purpose: Avoid rate-based detection
...
## 🕵️‍♂️ Lab Example: HTB Academy Hard

> [!INFO] Scenario: Target has restrictive firewall that blocks most scans
