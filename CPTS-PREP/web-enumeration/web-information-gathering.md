# 🛰️ Web Application Enumeration

## 🔍 Overview

This guide details the process of enumerating web applications and their components to gather information that can be used for further security testing, penetration testing, and reconnaissance purposes.
...
- **Virtual Host Discovery** - Finding additional applications on the same server
