...
> [!ABSTRACT] 
> This document provides an overview of basic usage, attack modes, hash type detection, common hash types, and performance tips for Hashcat.
...
List all hash types supported by Hashcat:
