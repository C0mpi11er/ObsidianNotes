```markdown
# 🛰️ Automated Scanning & Tools - HTB Academy Guide

> [!ABSTRACT] Overview
> This guide covers automated tools and techniques for discovering LFI vulnerabilities and escalating them efficiently across large applications and networks.
