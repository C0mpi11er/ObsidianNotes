...
> [!ABSTRACT] Complete guide covering Local File Inclusion (LFI), Remote File Inclusion (RFI), and advanced file inclusion techniques from HTB Academy's File Inclusion module.
...
**🟡 Intermediate** → [[Advanced Bypasses & PHP Filters]] → [[PHP Wrappers for RCE]]  
**🟠 Advanced** → [[Remote File Inclusion (RFI)]] → [[Log Poisoning Techniques]]  
**🔴 Expert** → [[Automated Scanning & Tools]] → [[Skills Assessment Walkthrough]]
