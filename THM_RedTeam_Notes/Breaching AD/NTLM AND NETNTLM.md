...
new technology lan manager is used for authenticating users in AD along side challeng response based scheme know as net ntlm 

for AD breaching password spraying is the best option as to much brtueforce can lead to a lock up


how to use below python script for ntlm password spraying 
